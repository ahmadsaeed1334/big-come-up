...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <small class="text-muted">Add a new transaction</small>
        </div>
            ...
            <form method="POST" action="{{ route('admin.payments.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-text">Normally order ka user hi select karo.</div>
                    </div>
                    ...
                    <div class="col-12 col-md-3">
                        ...
                        <select name="method" class="form-select" required>
                            @foreach (['card', 'bank', 'paypal', 'stripe', 'cash', 'other'] as $m)
                                <option value="{{ $m }}" @selected(old('method', 'other') === $m)>
                                    {{ strtoupper($m) }}
                                </option>
                            @endforeach
                        </select>
