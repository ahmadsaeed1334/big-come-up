            ...
            <form method="POST" action="{{ route('admin.competitions.update', $competition) }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 col-md-6">
                        ...
                        <div class="form-text">
                            Auto ON ho to title edit karne par slug bhi update hoga.
                        </div>
                    </div>

                    <div class="col-12">
                        <label class="form-label">Description</label>
                        <textarea name="description" class="form-control" rows="3">{{ old('description', $competition->description) }}</textarea>
                    </div>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <select name="status" class="form-select" required>
                            @foreach (['draft', 'active', 'closed'] as $s)
                                <option value="{{ $s }}" @selected(old('status', $competition->status) === $s)>
                                    {{ ucfirst($s) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-12 col-md-4">
                        ...
                        <input type="datetime-local" name="start_date" class="form-control"
                            value="{{ old('start_date', optional($competition->start_date)->format('Y-m-d\TH:i')) }}">
                    </div>

                    <div class="col-12 col-md-4">
                        <label class="form-label">End Date</label>
                        <input type="datetime-local" name="end_date" class="form-control"
                            value="{{ old('end_date', optional($competition->end_date)->format('Y-m-d\TH:i')) }}">
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="rules" class="form-control" rows="4">{{ old('rules', $competition->rules) }}</textarea>
                    </div>
                </div>
